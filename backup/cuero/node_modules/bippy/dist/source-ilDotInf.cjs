...
//#endregion
const require_src = require('./src-D-ehe7ED.cjs');
...
const describeFiber = (fiber, childFiber) => {
	...
	switch (tag) {
		...
		case require_src.HostComponentTag:
		case require_src.HostHoistableTag:
		case require_src.HostSingletonTag: return describeBuiltInComponentFrame(fiber.type);
