...
export const FAQ = () => {
  const { replacer } = usePersonalization();
                ...
                >
                  <div className="flex items-center justify-between mobile-stack mobile-center">
                    <div className="flex items-start gap-4 mobile-stack mobile-center">
                      ...
                      `}>
                        {replacer ? replacer.replace(item.question) : item.question}
                      </h3>
                    </div>
                  ...
                  <div className="px-6 pb-6 border-t border-border/50">
                    <div className="pt-6">
                      <p className="text-lg text-muted-foreground leading-relaxed mobile-center-text">
                        {replacer ? replacer.replace(item.answer) : item.answer}
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-3xl p-8 md:p-12 border border-accent/30 mobile-center">
            <div className="text-center space-y-6 mobile-center">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8 mobile-center-text">
                {replacer ? replacer.replace('Los reyes no se paralizan por el análisis. Actúan con información suficiente y dominio.') : 'Los reyes no se paralizan por el análisis. Actúan con información suficiente y dominio.'}
              </p>
