      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 mb-16">
          {uniqueCombination.map((item, index) => {
            ...
            return (
              <div key={index} className="p-8 rounded-2xl bg-card/80 backdrop-blur-sm border border-border/50 hover:border-accent/50 transition-smooth">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-black rounded-3xl p-8 md:p-12 border border-accent/30">
            <div className="text-center space-y-6">
              ...
              <div className="w-full h-auto max-w-md mx-auto mb-8">
                <img 
                  src={logoDi} 
                  alt="LoDi Logo"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-3xl p-8 md:p-12 shadow-strong border border-accent/30">
            <div className="text-center space-y-6">
              ...
              >
                Evaluar si tengo lo necesario para dominar mi mercado
