...
const HeroQuote = () => {
  ...
  return (
    <p
      className="text-base sm:text-lg md:text-xl text-white/90 italic leading-relaxed"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 order-1 md:order-1 mobile-center">
            <div className="inline-block px-3 py-1 sm:px-4 sm:py-1.5 md:py-2 bg-accent/10 backdrop-blur-sm rounded-full border border-accent/20 mb-2 sm:mb-3 md:mb-4 mobile-center-block">
              <PersonalizedText as="span" className="text-accent font-semibold text-xs sm:text-sm md:text-base text-white">
            ...
            <p className="leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white mt-4">
              Bien. Estás aquí.
            </p>

            <PersonalizedText as="p" className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto lg:mx-0 leading-relaxed mobile-center-text">
            ...
            <PersonalizedText as="p" className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto text-center mobile-center-text">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center pt-4 sm:pt-6 md:pt-8 mobile-center-flex">
              <Button
                ...
                className="accent-gradient text-white hover:scale-105 transition-bounce shadow-strong w-full sm:w-auto px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 group mx-auto sm:mx-0 whitespace-normal break-words text-center enhanced-button-mobile sm:enhanced-button-tablet md:enhanced-button-desktop font-semibold"
              >
            ...
            <div className="space-y-2 pt-2 sm:pt-3 md:pt-4 mobile-center-text">
              ...
              <p className="text-xs sm:text-sm text-white/60 text-center font-medium">
          ...
          <div className="order-2 md:order-2 mobile-center">
            <div
              className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-strong aspect-[4/5] sm:aspect-[3/4] md:aspect-[5/4] lg:aspect-[4/3] cursor-pointer group mobile-center-block"
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="bg-accent/90 rounded-full p-4 sm:p-6 shadow-strong transform scale-95 group-hover:scale-100 transition-transform animate-pulse sm:animate-none">
